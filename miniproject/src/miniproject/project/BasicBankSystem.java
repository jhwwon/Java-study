...
//전체 시스템을 관리
public class BasicBankSystem {  //은행 시스템이 처음 시작될 때는 항상 같은 상태를 유지해야 하기 때문에 매개변수가 없는 기본 생성자를 생성
	...
	public BasicBankSystem() {   //매개변수가 없는 기본 생성자
	...
	public static void main(String[] args) {
		...
		bankSystem.loadDataFromFile();  //실행하기 전에 저장했던 파일을 가져오기
		bankSystem.runMenu();
	}
}